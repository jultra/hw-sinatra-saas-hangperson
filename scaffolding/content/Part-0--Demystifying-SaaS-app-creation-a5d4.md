...
There are more details on rerun's usage available in the gem's [GitHub README](https://github.com/alexch/rerun#usage). Gems are usually on GitHub and their READMEs are usually full of helpful instructions about how to use them.
...
**For Codio users, we suggest using the apt-get command: `curl https://cli-assets.heroku.com/install-ubuntu.sh | sh`**
